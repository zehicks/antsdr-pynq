...
proc create_root_design { parentCell } {
  ...
  # Create instance: overlay_reset, and set properties
  set overlay_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 overlay_reset ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {32} \
   CONFIG.DIN_TO {32} \
   CONFIG.DIN_WIDTH {64} \
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#gpio[16]#gpio[17]#gpio[18]#gpio[19]#gpio[20]#gpio[21]#gpio[22]#gpio[23]#gpio[24]#gpio[25]#gpio[26]#gpio[27]#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#gpio[46]#gpio[47]#gpio[48]#gpio[49]#gpio[50]#gpio[51]#gpio[52]#gpio[53]} \
  ...
  connect_bd_net -net axi_ad9361_l_clk [get_bd_pins axi_ad9361/clk] [get_bd_pins axi_ad9361/l_clk] [get_bd_pins axi_ad9361_dac_fifo/dout_clk] [get_bd_pins overlay_top_0/i_rx_clk] [get_bd_pins util_ad9361_adc_fifo/din_clk] [get_bd_pins util_ad9361_divclk/clk]
  ...
  connect_bd_net -net overlay_top_0_o_Q0_data [get_bd_pins overlay_top_0/o_Q0_data] [get_bd_pins util_ad9361_adc_fifo/din_data_1]
  ...
  connect_bd_net -net overlay_top_0_o_Q1_data [get_bd_pins overlay_top_0/o_Q1_data] [get_bd_pins util_ad9361_adc_fifo/din_data_3]
  ...
  connect_bd_net -net sys_ps7_GPIO_O [get_bd_ports gpio_o] [get_bd_pins overlay_reset/Din] [get_bd_pins sys_ps7/GPIO_O]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins overlay_reset/Dout] [get_bd_pins overlay_top_0/i_rst]
